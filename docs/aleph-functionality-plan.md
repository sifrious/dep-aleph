...
bytes and records text from DOCX, XLSX, PPTX, PDF, Markdown, CSV, and plain-text files as Funes
extractions. Slack has a Web API polling adapter that resolves opaque
